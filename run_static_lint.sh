...
# RUNNING THE CHECK
julia --project=StaticLint.jl -e "using StaticLint ; open(\"result.txt\", \"w\") do io StaticLint.run_lint(\"src\"; io, filters=essential_filters, formatter=MarkdownFormat()) end" 
